...
public class CatalogAccess
{
    ...
    public static ProductDetails GetProductDetails(string productId)
    {
        ...
        if (table.Rows.Count > 0)
        {
            ...
            details.Description = dr["FlowersType"].ToString();
    ...
    howManyPages)
    {
        ...
        param.Value = FPconfiguration.ProductDescriptionLength;
        param.DbType = DbType.Int32;
        comm.Parameters.Add(param);
        // create a new parameter
        ...
        param.Value = FPconfiguration.ProductsPerPage;
        param.DbType = DbType.Int32;
        comm.Parameters.Add(param);
        // create a new parameter
        param = comm.CreateParameter();
        ...
        (double)FPconfiguration.ProductsPerPage);
